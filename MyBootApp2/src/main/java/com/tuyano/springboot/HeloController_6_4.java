...
//
//@Controller
//public class HeloController_6_4 {
//
...
//	
//	MyDataDaoImpl_6_7 dao;
//	
//	@RequestMapping(value = "/" , method = RequestMethod.GET)
//	public ModelAndView find(ModelAndView mav) {
//		mav.setViewName("index_30");
//		mav.addObject("title", "Find Page");
//		mav.addObject("msg", "MyData의 예제입니다.");
//		mav.addObject("value","");
//		Iterable<MyData_5_3> list =dao.getAll(); //repository.findAllOrderByName();dao.findByAge(10, 40);
...
//	@PostConstruct
//	public void init() {
//		dao = new MyDataDaoImpl_6_7(entityManager);
