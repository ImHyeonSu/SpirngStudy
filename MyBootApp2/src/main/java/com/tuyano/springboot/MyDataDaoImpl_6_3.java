...
//
//@Repository
//public class MyDataDaoImpl_6_3 implements MyDataDao_6_2<MyData_5_2> {
//	private static final long serialVersionUID = 1L;
//	
//	private EntityManager entityManager; //엔터티를 처리하기 위한 기능이 있다. 그래서 엔터티 처리를 위해서는 무조건 필요하다.
//	
//	public MyDataDaoImpl_6_3() {
//		super();
//	}
//	
//	public MyDataDaoImpl_6_3(EntityManager manager) {
...
//		String qstr = "from MyData_5_2 where id = :fid or name like :fname or mail like :fmail"; // :fstr 처럼 :oo같은 형식으로 작성된 것은 JPQL쿼리문 내에서 매개변수용 변수로 사용된다. 
//		Long fid = 0L;
//		try {
...
//			e.printStackTrace();
//		}
//		Query query = entityManager.createQuery(qstr).setParameter("fid", fid).setParameter("fname", "%" + fstr + "%").setParameter("fmail", fstr + "@%"); //메서드 체인 기술을 사용해서 연속으로 파라미터를 3개 지정하고 있다.하나의 쿼리내에서 다수의 매개변수 설정이 가능하다.
