...
//
//@Controller
//public class HeloController_6_2 {
//
...
//		mav.addObject("value","");
//		Iterable<MyData_5_2> list = dao.getAll();  
...
//			List<MyData_5_2> list = dao.find(param);
//			mav.addObject("datalist", list);
//		}
//		return mav;
//	}
...
//	@PostConstruct
//	public void init() {
//		dao = new MyDataDaoImpl_6_3(entityManager);
